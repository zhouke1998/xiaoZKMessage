...
<head>
    ...
    <script type="text/javascript" src="./js/pwdManage.js"></script>
	<script>
        ...
        <div id="reset_body">
            <div class="content"  style="display:none;">
                <div class="tips">
                    <p>
                        <i></i>
                        <span>经过检测，账号<b class="user_id">*****</b>可设置密保问题</span>
                    </p>
                </div>
            ...
            <div class="tips" id="has_set" style="display:none;">
                	<p><i></i>经检测，账号<b class="user_id">*****</b>已设置密保问题，您可<a href="/pwdManage/change_pwdManage_verify">修改密保</a></p>
            </div>
        </div>
    </div>
    <div id="footer">
