    <%@ page language="java" contentType="text/html; charset=UTF-8"
        ...
        <!--[if lte IE 8]> <script> location = "/ie.html?url=" + encodeURIComponent(location.href); </script>
        <![endif]-->
        <style>
        *{ padding:0; margin:0; box-sizing: border-box;font-family: "微软雅黑"; }
        ...
        .btn{ width:200px; margin:0 auto; max-width:100%; margin-top:40px; }
        .btn a{ float:left; text-decoration: none; width:100%; border:1px solid #5298ff; background:#5298ff; color:#FFF;
        display:block; height:46px; line-height:44px; text-align:center; font-size:16px; border-radius:3px; overflow:
        hidden; }
        ...
        <body>
        <div class="container">
        <img src="/error/img/404jpg.jpg" class="bg">
        <div class="btn">
